        ...
        var callRequest = function() {
            $.ajax({
                ...
                .done(function(responseData) {
                    ...
                    settings.requestComplete = settings.requestComplete+1;
                })
                .always(function(jqXHR) {
                    ...
                    if (!requestWithError) {
                        var progressCalc = Math.floor((settings.requestComplete / settings.requestNumTotal) * 100);
